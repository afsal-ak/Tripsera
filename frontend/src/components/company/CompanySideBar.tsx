...
export const CompanySidebar = ({ isOpen, onToggle, collapsed, onCollapse }: CompanySidebarProps) => {
      ...
      >
        <div className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            {!collapsed && <h2 className="text-xl font-bold text-orange">CompanyAdmin Panel</h2>}
          </div>
