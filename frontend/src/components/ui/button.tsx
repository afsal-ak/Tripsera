  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ocean: "bg-gradient-ocean text-white hover:shadow-glow transition-bounce",
        sunset: "bg-gradient-sunset text-white hover:shadow-elegant transition-bounce",
        success: "bg-success text-white hover:bg-success/90 transition-smooth",
        premium: "bg-gradient-card border-2 border-ocean-primary/20 text-ocean-primary hover:shadow-card transition-bounce",
      },
      size: {
