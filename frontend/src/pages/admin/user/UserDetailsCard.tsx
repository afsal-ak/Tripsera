...
import { Mail, User, Calendar, Users, UserCheck, Award, Shield } from 'lucide-react';
...
const UserDetailsCard = ({ userData, onToggleBlock }: UserDetailsProps) => {
  return (
    <Card className="max-w-full mx-auto shadow-lg border rounded-2xl overflow-hidden">
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          {userData.gender && (
            <InfoRow icon={<UserCheck size={16} />} label="Gender" value={userData.gender} />
          )}
          <InfoRow
            icon={<Users size={16} />}
            label="Followers"
