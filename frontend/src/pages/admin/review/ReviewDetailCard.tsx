    ...
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-md space-y-6">
      ...
      <div className="bg-gray-50 p-6 rounded-md shadow-lg space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-gray-900">User: {reviewData?.userId?.username}</h3>
        ...
        {/* Package Details */}
        <h4 className="font-semibold text-gray-900">Package: {reviewData?.packageId?.title}</h4>
