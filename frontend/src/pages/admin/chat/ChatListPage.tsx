...
// }> = ({ className = "", onRoomSelect, selectedRoomId, isCollapsed = false, onToggleSidebar }) => {
...
//   //   try {
//   //     setLoading(true);
//   //     const data = await handleSearchUserForChat();
//   //     setRooms(data);
//   //   } catch (error:any) {
...
//         otherParticipant?.location?.toLowerCase().includes(searchTerm) ||
...
//   if (isCollapsed) {
//     return (
//       <div className={`w-16 bg-white border-r border-gray-200 flex flex-col h-full ${className}`}>
...
//       <ChatListHeader onToggleSidebar={onToggleSidebar} showToggle={!!onToggleSidebar} />
...
export const AdminChatList: React.FC<{
  ...
  // TODO: Replace with actual logged-in user ID from Redux/Auth context
//  const currentUserId = "683f1be1fea446657f9be6f7";
