...
import {
  ...
  confirmBooking,
  changeTravelDate,
} from '@/services/company/bookingService';
import { getPackageById } from '@/services/company/packageService';
              ...
              <CardContent className="space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-700">{booking?.contactDetails?.phone || 'N/A'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-700">{booking?.contactDetails?.email || 'N/A'}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
