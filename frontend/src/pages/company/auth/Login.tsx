...
import { useDispatch, useSelector } from 'react-redux';
 import { loginCompany } from '@/redux/slices/companyAuthSlice';
...
const Login = () => {
  ...
  const { loading, error, isAuthenticated } = useSelector((state: RootState) => state.companyAuth);
  ...
  const handleSubmit = async () => {
    ...
    try {
      await dispatch(loginCompany({ email: trimmedEmail, password: trimmedPassword })).unwrap();
      ...
      <div className="flex w-full max-w-5xl shadow-lg rounded-lg overflow-hidden bg-white">
        ...
        <div className="hidden md:flex md:w-1/2 bg-orange items-center justify-center p-8">
          <div className="text-center text-white">
            <h2 className="text-3xl font-bold mb-4">Welcome Back to Tripsera Company</h2>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="mb-6 text-right">
                <Link to="/company/forgot-password" className="text-sm text-orange hover:underline">
            ...
            <p className="mt-4 text-sm text-center text-muted-foreground">
              ...
              <Link to="/company/signup" className="text-orange hover:underline">
                Signup
              </Link>
            </p>
          </form>
