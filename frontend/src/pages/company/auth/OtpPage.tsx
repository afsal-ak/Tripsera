...
import { useNavigate } from 'react-router-dom';
 import { handleCompanyVerifyAndRegister,handleCompanyResendOtp } from '@/services/company/companyAuthService';
...
const VerifyOtp = () => {
  ...
  const handleVerify = async () => {
    ...
    setLoading(true);
    try {
      await handleCompanyVerifyAndRegister(email, otp);
  ...
  const handleResend = async () => {
    ...
    try {
      await handleCompanyResendOtp(email);
