...
// import { handleVerifyOtp, handleForgotPassword } from '@/services/company/companAuthService';
import { handleCompanyVerifyOtp,handleCompanyForgotPassword } from '@/services/company/companyAuthService';
...
const ForgotOtpPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const res = await handleCompanyVerifyOtp(email, otp);
      ...
      navigate('/company/forgot-password/change-password');
  ...
  const handleResend = async () => {
    try {
      if (!email) return;
      await handleCompanyForgotPassword(email);
