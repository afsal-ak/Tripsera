...
import { getCategory } from '@/services/company/packageService';///need to add caegory api
...
import { addPackageForUser } from '@/services/company/customPkgService';
import type { ICustomAdminPackage } from '@/types/ICustomPkg';
import { getCustomPkgById } from '@/services/company/customPkgService';
...
const CreateCustomPackagePage = () => {
  ...
  const onSubmit = async (data: AddPackageFormSchema) => {
    try {
      ...
      navigate(`/company/custom-packages/${customId}`);
