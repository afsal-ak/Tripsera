...
import {
  ...
  deleteCustomPkg,
  updateCustomPkg,
} from '@/services/company/customPkgService';
...
const CustomPackageDetails = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate('/company/custom-packages');
    } catch (error: any) {
  ...
  const handleCreateCustomPackage = () => {
    navigate(`/company/custom-package/create/${pkg?.id}`);
  };
        ...
        <CardContent className="space-y-6 mt-4">
          ...
          {pkg.adminResponse && (
            <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg shadow-sm mt-6">
              <h3 className="text-lg font-semibold text-blue-700">Company Response</h3>
