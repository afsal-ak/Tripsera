...
import { addPackage } from '@/services/company/packageService';
import { getCategory } from '@/services/company/packageService';
...
console.log(categoryOptions,'cataaaaaaaatt');
...
console.log(categoryOptions,'cattt');
