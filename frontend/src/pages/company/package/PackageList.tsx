...
import { fetchPackagesData, blockPackage, unBlockPackage } from '@/services/company/packageService';
...
const PackageList = () => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <Button onClick={() => navigate('/company/packages/add')}>Add Packages</Button>
      </CardHeader>
      <CardContent>
        <FilterBar
  ...
  <Button
    onClick={() => navigate(`/company/package/edit/${pkg._id}`)}
  ...
  <Button
    onClick={() => navigate(`/company/package/${pkg._id}`)}
