  ...
  return (
    <div className="px-3 sm:px-6 py-4">
      <Card className="p-4 sm:p-6 shadow-xl border rounded-xl">
        ...
        <CardContent>
          {pkg.length === 0 ? (
            <p className="text-center py-6">No custom packages found.</p>
          ) : (
            <>
              {/* ✅ MOBILE VIEW (CARD) */}
                ...
                {pkg.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Type:</span> {item.tripType}
                    </p>
              ...
              <div className="hidden md:block overflow-x-auto">
                <Table>
                  <TableCaption>Your custom packages</TableCaption>
                  <TableHeader>
                    <TableRow>
