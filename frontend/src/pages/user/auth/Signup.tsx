...
import { handlePreRegister } from '@/services/auth/authService';
...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await handlePreRegister(email, username, password, refferalCode);
      localStorage.setItem('signupEmail', email);
      snackbar.success('OTP sent to your email')
    //  toast.success('OTP sent to your email');
      navigate('/verify-otp');
    } catch (error: any) {
      snackbar.error(error.response?.data?.message || 'Signup failed')
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-poppins bg-gradient-to-br from-gray-50 to-orange-50 px-4">
      <div className="flex w-full max-w-5xl shadow-xl rounded-xl overflow-hidden bg-white border border-gray-200">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-orange"
                value={username}
            ...
            <div className="mb-4 relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 px-4 py-2 pr-10 rounded-md focus:outline-none focus:ring-2 focus:ring-orange"
                value={password}
              ...
              <button
                ...
                className="absolute right-3 top-[38px] text-gray-500 hover:text-orange"
              >
            ...
            <button
              type="submit"
              className="w-full bg-orange text-white py-2 rounded-md hover:bg-orange-dark transition mb-4 flex justify-center items-center gap-2"
              disabled={loading}
            >
              {loading && (
            ...
            <div className="w-64 mx-auto flex items-center justify-center py-2">
              <GoogleLoginButton />
            </div>
