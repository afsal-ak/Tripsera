  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <Input  name='email' type="email" value={newEmail} onChange={handleEmailChange} placeholder="Enter new email" />
        <Button type="submit" disabled={loading} className="mt-2">  {loading ? 'Loading...' : 'Send Otp'}</Button>
        </form>
      </div>
      ...
      <div>
       ...
       <div>
        ...
        <Input value={confirmPassword} onChange={(e)=>setConfirmPassword(e.target.value)} type="password" placeholder="New password" />
          {formErrors.confirm && (
