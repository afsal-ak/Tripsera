...
import { applyCoupon, createBookingWithWalletPayment, createBookingWithOnlinePayment, verifyRazorpayPayment, cancelUnpaidBooking } from '@/features/services/user/bookingService';
...
import { CheckCircle, Plane, Plus, Minus, Tag, XCircle, CreditCard, Wallet, Zap, Check } from 'lucide-react';
...
const CheckoutPage = () => {
  ...
  const handlePayment = async (formData: BookingFormSchema) => {
    try {
      ...
      } else if (formData.paymentMethod === 'razorpay' || formData.paymentMethod === 'wallet+razorpay') {
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                {isCouponApplied && !couponError && <p className="text-green-600 text-sm mt-2">Coupon applied successfully!</p>}
...
/>
            ...
            <Card className="shadow-travel">
              <CardContent className="p-6">
                <div className="mb-6">
                  <h3 className="text-xl font-semibold text-foreground mb-2 font-poppins">Payment Method</h3>
            ...
            <Card className="sticky top-4">
              <CardContent className="p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {(watch("paymentMethod") === "wallet" || watch("paymentMethod") === "wallet+razorpay") && (
                    <div className="flex justify-between">
