...
import { handleDeleteReview, handleChangeStatus, handleReviewDetail } from '@/features/services/admin/reviewService'
        ...
        <div className="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-md space-y-6">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-4">
                    ...
                    <ConfirmDialog title="Change this review status?" actionLabel={review?.isBlocked ? 'Unblock' : 'Block'} onConfirm={() => handleBlockToggle(review?._id!, review?.isBlocked!)}>
            ...
            <div className="bg-gray-50 p-6 rounded-md shadow-lg space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-500">Published: {formatTimeAgo(review?.createdAt!)}</span>
                </div>
