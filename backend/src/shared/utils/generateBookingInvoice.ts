...
// // export async function generateBookingInvoice(booking: IBooking, invoiceCode: string): Promise<Buffer> {
...
// //     </head>
// //     <body>
// //       <h1>Booking Invoice – ${invoiceCode}</h1>
// //       <div class="section">
// //         <strong>Booking Code:</strong> ${booking.bookingCode} <br/>
// //          <strong>Package Code:</strong> ${(booking.packageId as any)?.packageCode || ''} <br/>
// //         <strong>Package:</strong> ${(booking.packageId as any)?.title || ''} <br/>
// //         <strong>Travel Date:</strong> ${formatDate(booking.travelDate)} <br/>
// //         <strong>Booking Date:</strong> ${formatDate(booking.bookedAt)} <br/>
// //       </div>

// //       <div class="section">
// //         <h3>Travler Details</h3>
// //         Name: ${(booking.userId as any)?.username || ''} <br/>
// //         Email: ${(booking.userId as any)?.email || ''} <br/>
// //         Phone: ${booking.contactDetails?.phone || ''} <br/>
// //       </div>
...
// //         Amount Paid: ₹${booking.amountPaid} <br/>
// //         ${booking.walletUsed ? `Wallet Used: ₹${booking.walletUsed} <br/>` : ''}
// //         ${booking.couponCode ? `Coupon Applied: ${booking.couponCode} (₹${booking.discount}) <br/>` : ''}
// //       </div>
// //     </body>
// //   </html>
// //   `;
...
// //  const companyLogoUrl = "https://yourdomain.com/logo.png"; // Replace with your logo URL
...
//   // Show watermark only if booking is cancelled
//     const cancelledWatermark = booking.bookingStatus === 'cancelled' ? `
...
//       <!-- Invoice title -->
//       <h1 style="text-align:center;">Booking Invoice – ${invoiceCode}</h1>
